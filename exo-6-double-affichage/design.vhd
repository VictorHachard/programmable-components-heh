-- Composant SSegments (decodeur 7 segments, instancie par DoubleAffichage)
library ieee;
...
-- Circuit principal : compteur 24 bits + affichage 7 segments (instancie SSegments)
library ieee;
use ieee.std_logic_1164.all;
...
entity DoubleAffichage is
    port    (
        ...
        DP, G, F, E, D, C, B, A : out std_logic := '0'
    );
end entity;
...
architecture ArchDoubleAffichage of DoubleAffichage is
    ...
    begin
        ...
        inst_SSegments : SSegments port map (
            NOT NBRE(20), NOT NBRE(21), NOT NBRE(22), NOT NBRE(23),
            DP, G, F, E, D, C, B, A
        );
